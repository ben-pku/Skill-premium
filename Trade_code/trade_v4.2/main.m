%% SC and Skill Premium in CN and US Trade  -- Version 4.2
% --------------------------------- Lijun Zhu, Zhuokai Huang 
% --------------------------------- time stamp is on the github
% v2-v3 using extend method to solve the whole locus of capital
% v3-v4 adding nonhomothetic CES preference
