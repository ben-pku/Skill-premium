 function pa = parameter_v4(N, O, J, TT)

% Initial Allocation
pa.l = [10,10,30;1,1,15;1,1,15]';
pa.l_j = [10,10,30;
           1, 1,15;
           1, 1,15]'; % initial worker in rural and urban sectors
pa.l_0 = [10,10,30;
           2, 2,30]'; % initial worker in rural and urban sectors
pa.k_0 = [10,25,40]'; % initial capital stock at t == 0
pa.k_1 = 1.02.*pa.k_0;  % initial capital stock at t == 1
...
pa.S3_0 = [0.4,0.3,0.3;0.1,0.8,0.1;0.1,0.1,0.8]; % initial trade share in service
pa.S_0 = [pa.S1_0,pa.S2_0,pa.S3_0];
...
pa.beta = 0.96;
pa.delta = 0.01;
pa.alpha_l = [0.5;0.2;0.2];
pa.alpha_k = [0.0;0.4;0.2];
pa.alpha_m1 = [0.2;0.1;0.2];
pa.alpha_m2 = [0.1;0.1;0.2];
pa.alpha_m3 = [0.2;0.2;0.2];
pa.alpha_m = [pa.alpha_m1,pa.alpha_m2,pa.alpha_m3];
pa.gamma1 = 0.4;
pa.gamma2 = 0.3;
pa.gamma3 = 0.3;
pa.gamma = [0.4,0.6];
