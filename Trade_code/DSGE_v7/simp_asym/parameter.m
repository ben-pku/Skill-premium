...
% trade
pa.S2 = [ 0.5 0.5 ;
                  0.35 0.65     ]; %sector 2  manufacturing
pa.S3 = [0.72 0.28 ;
               0.25 0.75 ]; %sector 3 low-skill service
pa.S4 = [ 0.72 0.28   ;
                 0.25 0.75  ]; % sector 4 high-skill service
% trade cost
...
% population
pa.L = [ 7.995;  1.64 ;  3  ]; % num+1 *1; 
pa.H = [  0.36 ;  1  ]; % num *1

% capital
pa.k0 = [ 0.09 ; 2.666  ] ; % num *1
