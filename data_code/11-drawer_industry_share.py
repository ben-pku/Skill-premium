...
ax.plot(year, cn_sl, marker='^',markersize=4, color='xkcd:grey', label='High Skill Service' )
ax.plot(year, cn_sh, marker='v',markersize=4, color='xkcd:grey', label='Low Skill Service' )
