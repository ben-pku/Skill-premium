...
set matsize 5000
set maxvar 32000
cd D:\Nutcore\我的坚果云\Destiny\课程\大三上\RA\助研\CFPS2016
use cfps2016famecon_201807.dta
...
replace hentrepreneur = 0 if fm1 == 5 /*工人家庭*/
...
//生成城乡变量
gen rural=0
replace rural=1 if urban16==0
gen urban=0
replace urban=1 if urban16==1

rename fswt_natcs16 fswt_nat

drop if nwealth == .

// 保留新生成的变量，得到2010CFPSwealth.dta
keep fid16 provcd fswt_nat psu subpopulation urban rural hentrepreneur land house othernfn nfnasset finasset deposit equity debt nwealth nethouse hsown hsownership hsown1
order fid16 provcd fswt_nat psu subpopulation urban rural hentrepreneur land house othernfn nfnasset finasset deposit equity debt nwealth nethouse hsown hsownership hsown1
sort fid 
save cfps2016wealth.dta,replace
...
/*前10%财富占比*/
total nwealth if nwid >= 12283 [pweight=fswt_nat]  /*全国*/
total nwealth if urban == 1 & gid >= 6195 [pweight=fswt_nat]  /*城市*/
total nwealth if rural == 1 & gid >= 6049 [pweight=fswt_nat]  /*农村*/
total nwealth [pweight=fswt_nat]
total nwealth if urban == 1 [pweight=fswt_nat]  /*城市*/
total nwealth if rural == 1 [pweight=fswt_nat]  /*农村*/

/*medium 40% 财富占比*/
total nwealth if nwid >= 7087 &  nwid < 12283 [pweight=fswt_nat]  /*全国*/
total nwealth if urban == 1 & gid >= 3490 &  gid < 6195 [pweight=fswt_nat]  /*城市*/
total nwealth if rural == 1 & gid >= 3466 &  gid < 6049 [pweight=fswt_nat]  /*农村*/

/*bottom 50% 财富占比*/
total nwealth if nwid < 7087 [pweight=fswt_nat]  /*全国*/
total nwealth if urban == 1 & gid < 3490 [pweight=fswt_nat] /*城市*/
total nwealth if rural == 1 & gid < 3466 [pweight=fswt_nat] /*农村*/
...
/*10%*/
mean hentrepreneur if nwid >= 12283 [pweight=fswt_nat] /*企业家(窄定义)*/
mean hentrepreneur if urban == 1 & nwid >= 12283 [pweight=fswt_nat]  /*城市*/
mean hentrepreneur if rural == 1 & nwid >= 12283 [pweight=fswt_nat]  /*农村*/
/*5%*/
mean hentrepreneur if nwid >= 12953 [pweight=fswt_nat] /*企业家(窄定义)*/
mean hentrepreneur if urban == 1 & nwid >= 12953 [pweight=fswt_nat]  /*城市*/
mean hentrepreneur if rural == 1 & nwid >= 12953 [pweight=fswt_nat]  /*农村*/
/*1%*/
mean hentrepreneur if nwid >= 13615 [pweight=fswt_nat] /*企业家(窄定义)*/
mean hentrepreneur if urban == 1 & nwid >= 13615 [pweight=fswt_nat]  /*城市*/
mean hentrepreneur if rural == 1 & nwid >= 13615 [pweight=fswt_nat]  /*农村*/
...
/*10%*/
total nwealth if nwid >= 12283 [pweight=fswt_nat]
total nwealth if urban == 1 & nwid >= 12283 [pweight=fswt_nat]  /*城市*/
total nwealth if rural == 1 & nwid >= 12283 [pweight=fswt_nat]  /*农村*/
total nwealth if hentrepreneur == 1 & urban == 1 & nwid >= 12283 [pweight=fswt_nat]  /*城市企业家*/
total nwealth if hentrepreneur == 1 & rural == 1 & nwid >= 12283 [pweight=fswt_nat]  /*农村企业家*/
/*5%*/
total nwealth if nwid >= 12953 [pweight=fswt_nat]
total nwealth if urban == 1 & nwid >= 12953 [pweight=fswt_nat]  /*城市*/
total nwealth if rural == 1 & nwid >= 12953 [pweight=fswt_nat]  /*农村*/
total nwealth if hentrepreneur == 1 & urban == 1 & nwid >= 12953 [pweight=fswt_nat]  /*城市企业家*/
total nwealth if hentrepreneur == 1 & rural == 1 & nwid >= 12953 [pweight=fswt_nat]  /*农村企业家*/
/*1%*/
total nwealth if nwid >= 13615 [pweight=fswt_nat]
total nwealth if urban == 1 & nwid >= 13615 [pweight=fswt_nat]  /*城市*/
total nwealth if rural == 1 & nwid >= 13615 [pweight=fswt_nat]  /*农村*/
total nwealth if hentrepreneur == 1 & urban == 1 & nwid >= 13615 [pweight=fswt_nat]  /*城市企业家*/
total nwealth if hentrepreneur == 1 & rural == 1 & nwid >= 13615 [pweight=fswt_nat]  /*农村企业家*/
...
/*0-25*/
ratio nethouse/nwealth if nwid < 3434 [pweight=fswt_nat]
ratio nethouse/nwealth if urban == 1 & nwid < 3434 [pweight=fswt_nat]  /*城市*/
ratio nethouse/nwealth if rural == 1 & nwid < 3434 [pweight=fswt_nat]  /*农村*/
ratio nethouse/nwealth if hentrepreneur == 1 & nwid < 3434 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid < 3434 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid < 3434 & urban == 1 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid < 3434 & urban == 1 [pweight=fswt_nat] 
ratio nethouse/nwealth if hentrepreneur == 1 & nwid < 3434 & urban == 0 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid < 3434 & urban == 0 [pweight=fswt_nat] 
/*25-75*/
ratio nethouse/nwealth if nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]
ratio nethouse/nwealth if urban == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*城市*/
ratio nethouse/nwealth if rural == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*农村*/
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 3434 & nwid < 10387 & urban == 1 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 3434 & nwid < 10387 & urban == 1 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 3434 & nwid < 10387 & urban == 0 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 3434 & nwid < 10387 & urban == 0 [pweight=fswt_nat]  
/*75-100*/
ratio nethouse/nwealth if nwid >= 10387 [pweight=fswt_nat]
ratio nethouse/nwealth if urban == 1 & nwid >= 10387 [pweight=fswt_nat]  /*城市*/
ratio nethouse/nwealth if rural == 1 & nwid >= 10387 [pweight=fswt_nat]  /*农村*/
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 10387 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 10387 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 10387 & urban == 1 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 10387 & urban == 1 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 10387 & urban == 0 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 10387 & urban == 0 [pweight=fswt_nat]  
/*10%*/
ratio nethouse/nwealth if nwid >= 12283 [pweight=fswt_nat]
ratio nethouse/nwealth if urban == 1 & nwid >= 12283 [pweight=fswt_nat]  /*城市*/
ratio nethouse/nwealth if rural == 1 & nwid >= 12283 [pweight=fswt_nat]  /*农村*/
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 12283 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 12283 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 12283 & urban == 1 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 12283 & urban == 1 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 12283 & urban == 0 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 12283 & urban == 0 [pweight=fswt_nat]  
/*5%*/
ratio nethouse/nwealth if nwid >= 12953 [pweight=fswt_nat]
ratio nethouse/nwealth if urban == 1 & nwid >= 12953 [pweight=fswt_nat]  /*城市*/
ratio nethouse/nwealth if rural == 1 & nwid >= 12953 [pweight=fswt_nat]  /*农村*/
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 12953 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 12953 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 12953 & urban == 1 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 12953 & urban == 1 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 12953 & urban == 0 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 12953 & urban == 0 [pweight=fswt_nat]  
/*1%*/
ratio nethouse/nwealth if nwid >= 13615 [pweight=fswt_nat]
ratio nethouse/nwealth if urban == 1 & nwid >= 13615 [pweight=fswt_nat]  /*城市*/
ratio nethouse/nwealth if rural == 1 & nwid >= 13615 [pweight=fswt_nat]  /*农村*/
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 13615 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 13615 [pweight=fswt_nat] 
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 13615 & urban == 1 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 13615 & urban == 1 [pweight=fswt_nat] 
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 13615 & urban == 0 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 13615 & urban == 0 [pweight=fswt_nat] 
/*2014 CFPS*/
clear
clear matrix
clear mata
...
/*50-90*/
ratio nethouse/nwealth if nwid >= 7087 & nwid < 12283 [pweight=fswt_nat]
ratio nethouse/nwealth if urban == 1 & nwid >= 7087 & nwid < 12283 [pweight=fswt_nat]  /*城市*/
ratio nethouse/nwealth if rural == 1 & nwid >= 7087 & nwid < 12283 [pweight=fswt_nat]  /*农村*/
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 7087 & nwid < 12283 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 7087 & nwid < 12283 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 7087 & nwid < 12283 & urban == 1 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 7087 & nwid < 12283 & urban == 1 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid >= 7087 & nwid < 12283 & urban == 0 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid >= 7087 & nwid < 12283 & urban == 0 [pweight=fswt_nat] 
/*0-50*/
ratio nethouse/nwealth if nwid < 7087 [pweight=fswt_nat]
ratio nethouse/nwealth if urban == 1 & nwid < 7087 [pweight=fswt_nat]  /*城市*/
ratio nethouse/nwealth if rural == 1 & nwid < 7087 [pweight=fswt_nat]  /*农村*/
ratio nethouse/nwealth if hentrepreneur == 1 & nwid < 7087 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid < 7087 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid < 7087 & urban == 1 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid < 7087 & urban == 1 [pweight=fswt_nat]  
ratio nethouse/nwealth if hentrepreneur == 1 & nwid < 7087 & urban == 0 [pweight=fswt_nat]  /*企业家*/
ratio nethouse/nwealth if hentrepreneur == 0 & nwid < 7087 & urban == 0 [pweight=fswt_nat] 
...
/*0-25*/
mean hsown if nwid < 3434 [pweight=fswt_nat]
mean hsown if urban == 1 & nwid < 3434 [pweight=fswt_nat]  /*城市*/
mean hsown if rural == 1 & nwid < 3434 [pweight=fswt_nat]  /*农村*/
mean hsown if hentrepreneur == 1 & nwid < 3434 [pweight=fswt_nat]  /*企业家*/
mean hsown if hentrepreneur == 0 & nwid < 3434 [pweight=fswt_nat]  /*企业家*/  
/*25-75*/
mean hsown if nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]
mean hsown if urban == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*城市*/
mean hsown if rural == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*农村*/
mean hsown if hentrepreneur == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*企业家*/
mean hsown if hentrepreneur == 0 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*企业家*/
/*75-100*/
mean hsown if nwid >= 10387 [pweight=fswt_nat]
mean hsown if urban == 1 & nwid >= 10387 [pweight=fswt_nat]  /*城市*/
mean hsown if rural == 1 & nwid >= 10387 [pweight=fswt_nat]  /*农村*/
mean hsown if hentrepreneur == 1 & nwid >= 10387 [pweight=fswt_nat]  /*企业家*/
mean hsown if hentrepreneur == 0 & nwid >= 10387 [pweight=fswt_nat]  /*企业家*/
/*10%*/
mean hsown if nwid >= 12283 [pweight=fswt_nat]
mean hsown if urban == 1 & nwid >= 12283 [pweight=fswt_nat]  /*城市*/
mean hsown if rural == 1 & nwid >= 12283 [pweight=fswt_nat]  /*农村*/
mean hsown if hentrepreneur == 1 & nwid >= 12283 [pweight=fswt_nat]  /*企业家*/
mean hsown if hentrepreneur == 0 & nwid >= 12283 [pweight=fswt_nat]  /*企业家*/
/*5%*/
mean hsown if nwid >= 12953 [pweight=fswt_nat]
mean hsown if urban == 1 & nwid >= 12953 [pweight=fswt_nat]  /*城市*/
mean hsown if rural == 1 & nwid >= 12953 [pweight=fswt_nat]  /*农村*/
mean hsown if hentrepreneur == 1 & nwid >= 12953 [pweight=fswt_nat]  /*企业家*/
mean hsown if hentrepreneur == 0 & nwid >= 12953 [pweight=fswt_nat]  /*企业家*/
/*1%*/
mean hsown if nwid >= 13615 [pweight=fswt_nat]
mean hsown if urban == 1 & nwid >= 13615 [pweight=fswt_nat]  /*城市*/
mean hsown if rural == 1 & nwid >= 13615 [pweight=fswt_nat]  /*农村*/
mean hsown if hentrepreneur == 1 & nwid >= 13615 [pweight=fswt_nat]  /*企业家*/
mean hsown if hentrepreneur == 0 & nwid >= 13615 [pweight=fswt_nat]  /*企业家*/
...
/*0-25*/
mean hsown1 if nwid < 3434 [pweight=fswt_nat]
mean hsown1 if urban == 1 & nwid < 3434 [pweight=fswt_nat]  /*城市*/
mean hsown1 if rural == 1 & nwid < 3434 [pweight=fswt_nat]  /*农村*/
mean hsown1 if hentrepreneur == 1 & nwid < 3434 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid < 3434 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid < 3434 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid < 3434 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid < 3434 & urban == 0 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid < 3434 & urban == 0 [pweight=fswt_nat]  /*企业家*/  
/*25-75*/
mean hsown1 if nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]
mean hsown1 if urban == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*城市*/
mean hsown1 if rural == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*农村*/
mean hsown1 if hentrepreneur == 1 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 3434 & nwid < 10387 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 3434 & nwid < 10387 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 3434 & nwid < 10387 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 3434 & nwid < 10387 & urban == 0 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 3434 & nwid < 10387 & urban == 0 [pweight=fswt_nat]  /*企业家*/
/*75-100*/
mean hsown1 if nwid >= 10387 [pweight=fswt_nat]
mean hsown1 if urban == 1 & nwid >= 10387 [pweight=fswt_nat]  /*城市*/
mean hsown1 if rural == 1 & nwid >= 10387 [pweight=fswt_nat]  /*农村*/
mean hsown1 if hentrepreneur == 1 & nwid >= 10387 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 10387 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 10387 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 10387 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 10387 & urban == 0 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 10387 & urban == 0 [pweight=fswt_nat]  /*企业家*/
/*10%*/
mean hsown1 if nwid >= 12283 [pweight=fswt_nat]
mean hsown1 if urban == 1 & nwid >= 12283 [pweight=fswt_nat]  /*城市*/
mean hsown1 if rural == 1 & nwid >= 12283 [pweight=fswt_nat]  /*农村*/
mean hsown1 if hentrepreneur == 1 & nwid >= 12283 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 12283 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 12283 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 12283 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 12283 & urban == 0 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 12283 & urban == 0 [pweight=fswt_nat]  /*企业家*/
/*5%*/
mean hsown1 if nwid >= 12952 [pweight=fswt_nat]
mean hsown1 if urban == 1 & nwid >= 12952 [pweight=fswt_nat]  /*城市*/
mean hsown1 if rural == 1 & nwid >= 12952 [pweight=fswt_nat]  /*农村*/
mean hsown1 if hentrepreneur == 1 & nwid >= 12952 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 12952 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 12952 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 12952 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 12952 & urban == 0 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 12952 & urban == 0 [pweight=fswt_nat]  /*企业家*/
/*1%*/
mean hsown1 if nwid >= 13613 [pweight=fswt_nat]
mean hsown1 if urban == 1 & nwid >= 13613 [pweight=fswt_nat]  /*城市*/
mean hsown1 if rural == 1 & nwid >= 13613 [pweight=fswt_nat]  /*农村*/
mean hsown1 if hentrepreneur == 1 & nwid >= 13613 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 13613 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 13613 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 13613 & urban == 1 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 1 & nwid >= 13613 & urban == 0 [pweight=fswt_nat]  /*企业家*/
mean hsown1 if hentrepreneur == 0 & nwid >= 13613 & urban == 0 [pweight=fswt_nat]  /*企业家*/
